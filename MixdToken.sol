/**
    MixdDAO(MIXD)
    Website: https://mixd.swapdao.app
    Twitter: @mixdcoin2023
    Telegram: https://t.me/daoswap_cn
...
contract MixdToken is ERC20, Ownable {
    ...
    constructor() ERC20("BBBToken", "BBB") {
        ...
        uint256 totalSupply = 600_000_000_000_000 * 1e18;
        ...
        teamWallet = address(0x944b604330D8BcA5231464F5063BebC99ed05FAa); // set as team wallet
    ...
    function updateBuyFees(
        ...
        buyTeamFee = _teamFee;
        buyTotalFees = buyRevShareFee + buyLiquidityFee + buyTeamFee;
        require(buyTotalFees <= 15, "Buy fees must be <= 15.");
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                _Liquidity = (fees * sellLiquidityFee) / sellTotalFees;
                _Team = (fees * sellTeamFee) / sellTotalFees;
                _RevShare = (fees * sellRevShareFee) / sellTotalFees;
            }
            // on buy
            else if (automatedMarketMakerPairs[from] && buyTotalFees > 0) {
                fees = amount.mul(buyTotalFees).div(100);
                _Liquidity = (fees * buyLiquidityFee) / buyTotalFees;
                _Team = (fees * buyTeamFee) / buyTotalFees;
                _RevShare = (fees * buyRevShareFee) / buyTotalFees;
            }

            if (fees > 0) {

                tokensForLiquidity += _Liquidity;
                tokensForTeam += _Team;
                tokensForRevShare += _RevShare;
                _Total = fees.sub(_RevShare);                
                super._transfer(from, address(this), _Total);
                super._burn(from,_RevShare);
            }
